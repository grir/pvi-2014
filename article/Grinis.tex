...
% papildomi Paketai----------------------------------------------
 \usepackage{color}
\title{Kai kurie polivalentinių sistemų modeliavimo geometriniai aspektai, II dalis}
...
@ARTICLE{Grinis12,
 ...
 title={ Kai kurie polivalentinių sistemų modeliavimo geometriniai aspektai},
 journal={Lietuvos matematikos rinkinys. Lietuvos matematikų draugijos darbai, ser. B}, 
 volume={53},
 number={1},
 year={2012},
 pages={62-67},
...
%\nocite{*}
\section*{Įvadas}
Šiame straipsnyje mes tęsiame kai kurių polivalentinių sąveikų geometrinių aspektų tyrinėjimus. 
...
Toliau mes naudojame panašią terminologiją kaip ir ankstesniame mūsų darbe \cite{Grinis12}. 
Skirtumas yra tas, kad ją mes formuluojame abstraktesniame kontekste. 
%Tarkime $(X,\rho)$ -- metrinė erdvė su metrika $\rho$. Polivalentinė sistema -- tai trejetas $(\mbox{Lig}, \mbox{Rec}, \mbox{R_{\rho}})$, kur $\mbox{Lig}$ -- uždaras $X$ poaibis, $\mbox{Rec}$ -- nesikertantis su  $\mbox{Lig}$ kitas uždaras $X$ poaibis, $R_{\rho} : X \times X \to [0,1] $ -- sąveikos funkcija. 
